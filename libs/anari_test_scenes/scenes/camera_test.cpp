...
CameraTest::CameraTest(anari::Device d) : TestScene(d)
{
...
anari::World CameraTest::world()
{
  return m_world;
}

void CameraTest::commit()
{
  auto d = m_device;
...
//  camera = anariNewCamera(d, "perspective");
//  anari::setParameter(d, camera, "position", glm::vec3(3.5f, 3.5f, 3.5f));
//  anari::setParameter(d, camera, "direction", glm::vec3(1.5f, 1.5f, 1.5f));
//  anari::setParameter(d, camera, "up", glm::vec3(1.5f, 1.5f, 1.5f));
...
{
  return new CameraTest(d);
}

//std::vector<Camera> CameraTest::cameras()
//{
//    Camera cam;
